<x-app-layout>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            <a class="rounded-full bg-orange-400 px-1.5 py-0.5 text-white" href="{{ route('korlap.aktivitas.index') }}">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h1 class="my-5 text-2xl font-bold">Detail Aktivitas</h1>
        </div>
        <div class="flex items-center gap-3">
            <a href={{ route('korlap.tugas.index', $activity->id) }}
                class="rounded-lg bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-600">
                Tugas Harian
            </a>
            <a href={{ route('korlap.aktivitas.absensi.index', $activity->id) }}
