  ...
  <div class="flex flex-wrap items-center justify-between">
    <div class="flex items-center justify-start">
      ...
      <a href="#" class="mr-4 flex items-center justify-between">
        <img src="{{ asset('assets/img/icon.svg') }}" class="-my-6 mr-3 h-24" alt="Logo" />
      </a>
    </div>
      ...
      <div class="z-50 my-4 hidden w-56 list-none divide-y divide-gray-100 rounded-xl bg-white text-base shadow"
        ...
        <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
          @if(Auth::user()->role == 'korlap')
            <li>
              <a href="{{ route('korlap.profil') }}" class="block px-4 py-2 text-sm hover:bg-gray-100">Profil Saya</a>
            </li>
          @elseif(Auth::user()->role == 'pimpinan')
            <li>
              <a href="{{ route('pimpinan.profil') }}" class="block px-4 py-2 text-sm hover:bg-gray-100">Profil Saya</a>
            </li>
          @else
            <li>
              <a href="{{ route('admin.profil') }}" class="block px-4 py-2 text-sm hover:bg-gray-100">Profil Saya</a>
            </li>
          @endif
        </ul>
        <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
