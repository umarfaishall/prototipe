    ...
    <table class="w-full text-left text-sm text-gray-500">
      <caption class="bg-white p-5 text-left text-lg font-semibold text-gray-900">
        <div class="flex items-center justify-between">
          <h2>List Relawan</h2>
          <a href="<?php echo e(route('admin.relawan.create')); ?>">
        ...
        <?php $__currentLoopData = $relawans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relawan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr class="border-b bg-white hover:bg-gray-50">
            ...
            <td class="flex items-center gap-3 px-6 py-4">
              <a href="<?php echo e(route('admin.relawan.edit', $relawan->id)); ?>"
              ...
              <form action="<?php echo e(route('admin.relawan.destroy', $relawan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/admin/relawan/index.blade.php ENDPATH**/ ?>