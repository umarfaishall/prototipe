...
<?php $component->withAttributes([]); ?>
  ...
  <div class="mb-4 rounded bg-white px-8 pb-8 pt-6 shadow-md">
    <form method="POST" action="<?php echo e(route('admin.profil.change-password')); ?>">
      <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/admin/profile.blade.php ENDPATH**/ ?>