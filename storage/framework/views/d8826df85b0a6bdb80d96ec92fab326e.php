...
<?php $component->withAttributes([]); ?>
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
            <a class="rounded-full bg-orange-400 px-1.5 py-0.5 text-white" href="<?php echo e(route('pimpinan.aktivitas.index')); ?>">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h1 class="my-5 text-2xl font-bold">Detail Aktivitas</h1>
        </div>
        <div class="flex items-center gap-3">
            <a href=<?php echo e(route('pimpinan.aktivitas.relawan.index', $activity->id)); ?>

                class="rounded-lg bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-600">
                Relawan
            </a>
            <a href=<?php echo e(route('pimpinan.aktivitas.absensi.index', $activity->id)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/pimpinan/aktivitas/show.blade.php ENDPATH**/ ?>