    ...
    <div class="mx-auto flex flex-col items-center justify-center px-6 py-8">
      <div class="w-full rounded-lg border bg-white shadow sm:max-w-md md:mt-0 xl:p-0">
        <div class="space-y-4 p-6 sm:p-8 md:space-y-6">
          ...
          <form class="space-y-4 md:space-y-6" action="<?php echo e(route('register')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div>
...
<?php endif; ?>
            <p class="text-sm font-light text-gray-500">
              Sudah punya akun?
              <a href="<?php echo e(route('login')); ?>" class="font-medium text-orange-500 hover:underline">
                Sign in
              </a>
            </p>
          </form>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/auth/register.blade.php ENDPATH**/ ?>