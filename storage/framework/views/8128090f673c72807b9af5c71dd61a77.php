...
<?php $component->withAttributes([]); ?>
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href=<?php echo e(route('admin.aktivitas.relawan.index', $activity->id)); ?>

                class="rounded-lg bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-600">
                Relawan
            </a>
            <a href=<?php echo e(route('admin.aktivitas.absensi.index', $activity->id)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/admin/aktivitas/show.blade.php ENDPATH**/ ?>