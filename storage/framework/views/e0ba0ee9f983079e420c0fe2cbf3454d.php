...
<?php $component->withAttributes([]); ?>
    <div class="flex items-center gap-2">
        ...
        <h1 class="my-5 text-2xl font-bold">Tambah Relawan</h1>
    </div>
    <form class="flex flex-col gap-8 bg-white p-5 sm:rounded-lg" action="<?php echo e(route('admin.relawan.store')); ?>" method="POST"
        ...
        <div class="flex flex-1 flex-col gap-4">
            <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
                <label for="name" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Nama
                    Relawan</label>
                <input type="text" id="name"
                    ...
                    placeholder="Nama Relawan" name="name" required />
            </div>
            <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
            ...
            <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
                <label for="password"
                    class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Password</label>
                <input type="password" id="password"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
                    placeholder="Password" name="password" required />
            </div>
            <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
                <label for="phone" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Nomor
                    Telepon</label>
                <input type="text" id="phone"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
                    placeholder="Nomor Telepon" name="phone" required />
            </div>
            <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
                <label for="domicile"
                ...
                <input type="text" id="domicile"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
                    placeholder="Domisili" name="domicile" required />
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/admin/relawan/create.blade.php ENDPATH**/ ?>