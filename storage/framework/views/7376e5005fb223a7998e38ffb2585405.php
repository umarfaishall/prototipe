      ...
      <div class="z-50 my-4 hidden w-56 list-none divide-y divide-gray-100 rounded-xl bg-white text-base shadow"
        ...
        <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
          ...
          <?php elseif(Auth::user()->role == 'pimpinan'): ?>
            <li>
              <a href="<?php echo e(route('pimpinan.profil')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100">Profil Saya</a>
            </li>
          <?php else: ?>
            <li>
              <a href="<?php echo e(route('admin.profil')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100">Profil Saya</a>
            </li>
          <?php endif; ?>
        </ul>
        <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
...
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/layouts/navbar/dashboard.blade.php ENDPATH**/ ?>