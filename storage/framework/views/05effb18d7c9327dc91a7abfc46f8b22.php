...
<?php $component->withAttributes([]); ?>
  <div class="flex items-center gap-2">
    ...
    <h1 class="my-5 text-2xl font-bold">Tambah Aktivitas</h1>
  </div>
  <form class="flex flex-col gap-8 bg-white p-5 sm:rounded-lg" action="<?php echo e(route('admin.aktivitas.store')); ?>" method="POST"
    enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <img src="" alt="aktivitas"
    ...
    <div class="flex flex-1 flex-col gap-4">
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        <label for="pilar" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Pilar Kegiatan</label>
        <input type="text" id="pilar"
          ...
          placeholder="Pendidikan" name="pilar_name" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        <label for="kegiatan" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Nama Kegiatan</label>
        <input type="text" id="kegiatan"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          placeholder="Kegiatan X" name="activity_name" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        ...
        <input type="number" id="jumlah_relawan"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          placeholder="100" name="volunteer_count" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        <label for="domisili" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Domisili</label>
        <input type="text" id="domisili"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          placeholder="Yogyakarta" name="domicile" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        ...
        <input type="text" id="titik_kumpul"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          placeholder="Kantor Lazismu DIY" name="rally_point" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
      ...
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        <label for="jam_kerja" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Jam Kerja</label>
        <div class="flex w-full items-center gap-2">
      ...
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        ...
        <input type="text" id="tugas"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          name="task" placeholder="Tugas X" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        <label for="kriteria" class="mb-2 block w-full text-sm font-medium text-gray-900 md:w-1/5">Kriteria</label>
        <input type="text" id="kriteria"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          name="criteria" placeholder="Kriteria X" required />
      </div>
      <div class="flex flex-wrap items-center gap-2 md:flex-nowrap">
        ...
        <input type="date" id="batas_pendaftaran"
          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-orange-500 focus:ring-orange-500"
          name="registration_limit" required />
      </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/admin/aktivitas/create.blade.php ENDPATH**/ ?>