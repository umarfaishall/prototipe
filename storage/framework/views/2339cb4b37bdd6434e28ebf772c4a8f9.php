    ...
    <div class="mx-auto flex flex-col items-center justify-center px-6 py-8">
      <div class="w-full rounded-lg border bg-white shadow sm:max-w-md md:mt-0 xl:p-0">
        <div class="space-y-4 p-6 sm:p-8 md:space-y-6">
          <img class="mx-auto" src="<?php echo e(asset('assets/img/icon.svg')); ?>" alt="icons">
          <div class="space-y-1">
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-orange-500 hover:underline">Lupa
                password?</a>
            </div>
            <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            <p class="text-sm font-light text-gray-500">
              Belum punya akun?
              <a href="<?php echo e(route('register')); ?>" class="font-medium text-orange-500 hover:underline">
                Register
              </a>
            </p>
          </form>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazizmu-laravel-main-3\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>